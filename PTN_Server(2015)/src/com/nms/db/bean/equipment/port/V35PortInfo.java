...
public class V35PortInfo implements java.io.Serializable{
	/**
	 * 
	 */
	private static final long serialVersionUID = -1426503049756213307L;
	private int id;//数据库主键id
	private int siteId;
	private int fourthLeg;//V35是否接入第4路E1
	private int timeModel;//定时模式
	private int frame;//成帧设置
	private int time1;//时隙1
	private int time2;
	private int time3;
	private int time4;
	private int time5;
	...
	public int getFourthLeg() {
		return fourthLeg;
	}
	public void setFourthLeg(int fourthLeg) {
