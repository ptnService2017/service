...
public class PerformanceInfo extends ViewDataObj{
	/**
	 * 
	 */
	private static final long serialVersionUID = 784934053947211254L;
	private int id;
	//网元的数据库id,设备查询时
	private int siteId;
	//网元名称
	...
	//盘地址
	private int MasterCardAddress;
	
	//用于标记是网元或板卡
	private int isCardOrSite;
...
//	}
	...
	public void setMasterCardAddress(int masterCardAddress) {
		MasterCardAddress = masterCardAddress;
	}
