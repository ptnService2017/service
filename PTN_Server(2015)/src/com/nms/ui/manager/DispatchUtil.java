...
public class DispatchUtil {
	 ...
	 * @throws Exception
	 */
//	public String topological(List<SiteInst> siteInsts,int netWorkId,List<Segment> seg) throws RemoteException, Exception {
//		
//		String result = ResourceUtil.srcStr(StringKeysTip.TIP_CONFIG_FAIL);
//		try {
//			if (this.object_interface instanceof SiteDispatchI) {
//				SiteDispatchI siteDispatchI = (SiteDispatchI) this.object_interface;
//				result =  validateResult(siteDispatchI.topologicalLinkFound(siteInsts, netWorkId,seg));
//			} else {
//				throw new Exception("object_interface is error");
//			}
//		} catch (Exception e) {
