...
public class AnalysisObjectID {

	public static String analysisObjectID(byte[] alarmIdBytes) {
		String name = "";
		byte[] t=new byte[]{0x00,0x00,0x00,alarmIdBytes[3]};
		...
		case 16:// VLAN VLAN
			...
			name="vlan/"+CoderUtils.bytesToInt(t);
			break;
		case 17:// DUAL DUAL
			//name = alarmIdInt + ":DUAL DUAL";
			name="dual/"+CoderUtils.bytesToInt(t);
			break;
		case 18:// MSP MSP
		//	name = alarmIdInt + ":MSP MS";
			name="msp/"+CoderUtils.bytesToInt(t);
			break;
		case 19:// RING RING
			//name = alarmIdInt + ":RING RING";
			name="ring/"+CoderUtils.bytesToInt(t);
			break;
		case 20:// CFP CFP
			//name = alarmIdInt + ":CFP CFP";
			name="cfp/"+CoderUtils.bytesToInt(t);
			break;
		case 21:// MCN
			//name = alarmIdInt + ":MCN";
			name="mcn/"+CoderUtils.bytesToInt(t);
			break;
		case 22:// CCN
			//name = alarmIdInt + ":CCN";
			name="ccn/"+CoderUtils.bytesToInt(t);
			break;
		case 23:// LAG
		//	name = alarmIdInt + ":LAG";
			name="lag/"+CoderUtils.bytesToInt(t);
			break;
		case 24:// track
