...
public class LagStatusObject {
	...
	private List<LagPortObject> lagPorts = new ArrayList<LagPortObject>();
	
	public List<LagPortObject> getLagPorts() {
		return lagPorts;
	}
	public void setLagPorts(List<LagPortObject> lagPorts) {
