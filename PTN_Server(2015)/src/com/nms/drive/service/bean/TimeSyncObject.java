...
public class TimeSyncObject {
	...
	private int srcclockpri1=0; //源时钟优先级1
	private int srcclockpri2=0; //源时钟优先级2
	...
	private List<PtpPortinfo> ptpPortinfo = new ArrayList<PtpPortinfo>();
	...
	public List<PtpPortinfo> getPtpPortinfo() {
		return ptpPortinfo;
	}
	public void setPtpPort(List<PtpPortinfo> ptpPortinfo) {
