...
public class TDMXml{
  ...
  private Element createFileContent(Document doc, List<CesInfo> cesinfos)
  {
    ...
    createElementNode(doc, "N", "rate", FieldName, "i", "2");
    createElementNode(doc, "N", "direction", FieldName, "i", "3");
    createElementNode(doc, "N", "activeState", FieldName, "i", "4");
    createElementNode(doc, "N", "owner", FieldName, "i", "5");
    createElementNode(doc, "N", "owneSserviceType", FieldName, "i", "6");
    createElementNode(doc, "N", "aEnd1TprmUID", FieldName, "i", "7");
    createElementNode(doc, "N", "aEnd1NermUID", FieldName, "i", "8");
    createElementNode(doc, "N", "aEnd1PortrmUID", FieldName, "i", "9");
    createElementNode(doc, "N", "aEnd1CTPID", FieldName, "i", "10");
    createElementNode(doc, "N", "aEnd2TprmUID", FieldName, "i", "11");
    createElementNode(doc, "N", "aEnd2NermUID", FieldName, "i", "12");
    createElementNode(doc, "N", "aEnd2PortrmUID", FieldName, "i", "13");
    createElementNode(doc, "N", "aEnd2CTPID", FieldName, "i", "14");
    createElementNode(doc, "N", "zEnd1TprmUID", FieldName, "i", "15");
    createElementNode(doc, "N", "zEnd1NermUID", FieldName, "i", "16");
    createElementNode(doc, "N", "zEnd1PortrmUID", FieldName, "i", "17");
    createElementNode(doc, "N", "zEnd1CTPID", FieldName, "i", "18");
    createElementNode(doc, "N", "zEnd2TprmUID", FieldName, "i", "19");
    createElementNode(doc, "N", "zEnd2NermUID", FieldName, "i", "20");
    createElementNode(doc, "N", "zEnd2PortrmUID", FieldName, "i", "21");
    createElementNode(doc, "N", "zEnd2CTPID", FieldName, "i", "22");
    createElementNode(doc, "N", "PW1rmUID", FieldName, "i", "23");
    createElementNode(doc, "N", "PW2rmUID", FieldName, "i", "24");
    ...
    for (CesInfo cesInfo : cesinfos)
    {
      ...
      createElementNode(doc, "V", cesInfo.getName(), Object, "i", "1");
      createElementNode(doc, "V", "2M", Object, "i", "2");
      createElementNode(doc, "V", "CD_BI", Object, "i", "3");
      createElementNode(doc, "V", cesInfo.getActiveStatus() == 1 ? "ACTIVE" : "PENDING", Object, "i", "4");
      createElementNode(doc, "V", cesInfo.getName(), Object, "i", "5");
      createElementNode(doc, "V", "--", Object, "i", "6");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getaSiteId(), Object, "i", "7");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getaSiteId(), Object, "i", "8");
      createElementNode(doc, "V", "3301EBCS1PRT" + cesInfo.getAxcId(), Object, "i", "9");
      createElementNode(doc, "V", "VC4=1", Object, "i", "10");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "11");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "12");
      createElementNode(doc, "V", "3301EBCS1PRT" + cesInfo.getZxcId(), Object, "i", "13");
      createElementNode(doc, "V", "VC4=1", Object, "i", "14");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "15");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "16");
      createElementNode(doc, "V", "3301EBCS1PRT" + cesInfo.getZxcId(), Object, "i", "17");
      createElementNode(doc, "V", "VC4=1", Object, "i", "18");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "19");
      createElementNode(doc, "V", "3301EBCS1NEL" + cesInfo.getzSiteId(), Object, "i", "20");
      createElementNode(doc, "V", "3301EBCS1PRT" + cesInfo.getAxcId(), Object, "i", "21");
      createElementNode(doc, "V", "VC4=1", Object, "i", "22");
      createElementNode(doc, "V", "3301EBCS1PSW" + cesInfo.getPwId(), Object, "i", "23");
