...
public class ESIXml {
    ...
    private List<Map<String,Object>> getETHList() {
    	...
    	try {
    		...
    		mapList = elanInfoService_MB.selectAll_ESINorth();
		} catch (Exception e) {
			e.printStackTrace();
		}finally{
	...
	private Element createFileContent(Document doc,List<Map<String,Object>> mapList) {
		...
		this.createElementNode(doc, "N", "zEndNermUID", FieldName, "i", "4");
		this.createElementNode(doc, "N", "role", FieldName, "i", "5");
