...
public class ETHXml {
	...
	public String getETHXml() {
		...
		String[] xmlPath = {"snmpData\\ZJ\\CS\\EB\\OMC\\CM\\"+DateUtil.getDate("yyyyMMdd"), "CM-PTN-ETH-A1-"+version+"-"+XmlUtil.getTime()+".xml"};
	...
	private void createXML(Document doc,List<Map<String,Object>> mapList){
		...
		root.appendChild(XmlUtil.fileHeader(doc,"Eth"));
