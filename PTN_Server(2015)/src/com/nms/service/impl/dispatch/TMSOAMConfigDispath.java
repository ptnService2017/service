...
public class TMSOAMConfigDispath extends DispatchBase implements DispatchInterface {
	...
	public String excuteInsert(Object object) throws Exception {
		...
		try {
			...
			String siteCheck =(String) siteUtil.irtualSiteAction(TypeAndActionUtil.ACTION_DELETE,oamInfo);
			if(null!=siteCheck){
				...
				if (manufacturer == EManufacturer.WUHAN.getValue()) {
					operationServiceI = new TMSOAMConfigWHServiceImpl();
				} else {
				}
