...
INSERT INTO `warninglevel` VALUES ('19', 'BRIDGE', '桥接', '5', '5', '98', null, '1', '如果设备采用共享复用段保护环，当环上光纤中断或断裂光路盘出现R-LOS告警或出现R-LOF、MS-AIS、MS-SD(信号劣化)、MS-EXC(复用段误码率突破）。当设备出现上述告警时，设备上相邻两站会发生桥接告警，通过这两个站的电路都会由工作信道桥接到保护信道。', '对业务没有影响', '', '1', '线路自动倒换', '通过网管查找告警类型，根据不同的告警故障采用不同的方法排除故障，当所有群路告警消失后等待几分钟，桥接告警就会消失。电路由保护信道返回到工作信道', 'Bridging');
...
INSERT INTO `warninglevel` VALUES ('35', 'TMC_CSF', '通路客户信号失效', '3', '3', '114', null, '1', '通路客户信号失效', '业务中断', null, '1', '本端客户层信号失效', '检查UNI口光纤是否连接好', 'Path client signal failure');
