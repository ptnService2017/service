...
-- ----------------------------
INSERT INTO `warninglevel` VALUES ('1', 'FAIL', '设备故障', '5', '5', '1', null, '6', '设备故障', '', '', '1', 'powerProblem ', null, 'Equipment Failure');
INSERT INTO `warninglevel` VALUES ('2', 'POWERALM', '电源故障', '5', '5', '2', null, '1', '电源故障', '业务误码或中断', null, '1', 'FOP-PM', '检查电源输出电压', 'Power Failure');
INSERT INTO `warninglevel` VALUES ('3', 'APS_MISMATCH', 'APS失配', '5', '5', '3', null, '3', 'APS失配', '业务只能工作在主用', '', '1', 'APS报文不符合规范', '检查APS模式是否正确', 'APS Mismatch');
INSERT INTO `warninglevel` VALUES ('4', 'SW_FAIL', '倒换失败', '5', '5', '4', null, '1', '倒换失败', '业务只能工作在主用', null, '1', 'FOP', '检查备用链路的OAM配置以及各相关端口是否LINK等', 'Switching Failure');
INSERT INTO `warninglevel` VALUES ('5', 'PTP_LOS', '精确时间同步丢失', '5', '5', '5', null, null, '精确时间同步丢失', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('6', 'TMC_LOC', '通路连接确认信号丢失', '5', '5', '6', null, '1', '通路连接确认信号丢失', '业务可能中断', null, '1', 'LOC', '检查链路连接是否正常，配置是否正确', null);
INSERT INTO `warninglevel` VALUES ('7', 'TMP_LOC', '通道连接确认信号丢失', '5', '5', '7', null, '1', '通道连接确认信号丢失', '业务可能中断', null, '1', 'LOC', '检查链路连接是否正常，配置是否正确', null);
INSERT INTO `warninglevel` VALUES ('8', 'ETH_LOC', '以太网连接确认信号丢失', '5', '5', '8', null, '1', '以太网连接确认信号丢失', '业务可能中断', null, '1', 'LOC', '检查本地和对端OAM配置是否正确', null);
INSERT INTO `warninglevel` VALUES ('9', 'TMP_SSF', '通道服务层信号失效', '5', '5', '9', null, null, '通道服务层信号失效', '业务可能中断', null, '1', '单盘做线路盘时，某条线路link_los或者线路收无光，如果某条入tunnel转发表的入端口是此线路号，那么这条TMP会上报TMP_SSF告警。', '检查链路连接是否正常', null);
INSERT INTO `warninglevel` VALUES ('10', 'TMS_LOC', '段连接确认信号丢失', '5', '5', '10', null, null, '段连接确认信号丢失', '业务可能中断', null, '1', 'LOC', '检查链路连接是否正常，配置是否正确', null);
INSERT INTO `warninglevel` VALUES ('11', 'LINK_LOS', '连接信号丢失', '5', '5', '11', null, '0', '连接信号丢失', '该端口相关的业务中断\r\n', '', '1', 'Link Fault', '检查连纤和光模块等', null);
INSERT INTO `warninglevel` VALUES ('12', 'PK_LOS', '丢包率过限', '5', '5', '12', null, '2', '丢包率过限', '业务丢包或误码', null, '1', 'Threshold Crossed', '看是否拥塞或者限速', null);
INSERT INTO `warninglevel` VALUES ('13', 'CLKI_LOS', '外时钟中断', '5', '5', '13', null, null, '外时钟源坏了；接外时钟的连线断了；时钟盘坏了', '对业务没有影响', null, '1', '外时钟端口down掉', '检查外时钟源工作是否正常；检查外时钟源的连线是否断了或者解除不好；若时钟盘坏了，更换一张时钟盘', null);
INSERT INTO `warninglevel` VALUES ('14', 'E1_LOS', '2M信号丢失', '5', '5', '14', null, '1', '2M信号丢失', 'E1接口没有信号输入', null, '1', 'LOS', '检测该设备是否连接2M线', null);
INSERT INTO `warninglevel` VALUES ('15', 'PTP_PORT_ALM', 'PTP端口异常告警', '4', '4', '65', null, '0', 'PTP端口异常告警', '业务中断', '', '1', 'PTP端口LinkDown', '检查PTP端口状态是否为Down', null);
INSERT INTO `warninglevel` VALUES ('16', 'TMS_SD', '段信号劣化', '4', '4', '66', null, '0', '可能是接收光功率太小或者太大，在接收机灵敏度附近或者过载；可能是光接头脏了使接收光功率不在正常范围内；光纤转接插头损伤或者解除不良，或者光纤断裂；可能是光路盘有故障', '业务可能中断', '', '1', '复用段信号劣化,暂时没有实现', '用光功率计测量接收光功率；检查接收光功率是否正常；检查光接头断面是否清洁，对端发送光功率是否正常；当接收功率过大时需加衰减器；接收光功率过小时可更换发送光功率大的机盘', null);
INSERT INTO `warninglevel` VALUES ('17', 'TMS_SF', '段信号失效', '4', '4', '67', null, null, '当某端设备的群路盘接收侧出线SPI-LOS、RS-LF等故障时，会向下游站传送一个对告信号MS-FERF或MS-RDI；当被测设备出线AU-LOP、TU-LOP…等故障时，会向对端设备发HP-FERF，对端会出现HE-FERF或HP-RDI告警，此告警信号通过发送侧传送到对端设备，对端就检测出了对告指示，产生远端告警，让发送端知道接收端已经收到了发来的高阶通道AIS或者检测到高阶通道失效，并回送一个高阶通道远端接收失效；通道未配置', '业务可能中断', null, '1', null, '由于此告警一般是由对端收不好产生或者本端发不好产生，应处理上游站的故障才能消除失效告警', null);
INSERT INTO `warninglevel` VALUES ('18', 'SWR', '倒收', '3', '3', '97', null, null, '由于主用信道上存在故障，不能正常工作，电路由主用信道倒换到备用信道', '无影响\r\n对业务没有影响', null, '1', '电路由主用信道倒换到备用信道', '检查光纤是否连接好；检查主用链路上是否有告警', null);
INSERT INTO `warninglevel` VALUES ('19', 'BRIDGE', '桥接', '5', '5', '98', null, '0', '如果设备采用共享复用段保护环，当环上光纤中断或断裂光路盘出现R-LOS告警或出现R-LOF、MS-AIS、MS-SD(信号劣化)、MS-EXC(复用段误码率突破）。当设备出现上述告警时，设备上相邻两站会发生桥接告警，通过这两个站的电路都会由工作信道桥接到保护信道。', '对业务没有影响', '', '1', '线路自动倒换', '通过网管查找告警类型，根据不同的告警故障采用不同的方法排除故障，当所有群路告警消失后等待几分钟，桥接告警就会消失。电路由保护信道返回到工作信道', null);
INSERT INTO `warninglevel` VALUES ('20', 'SWTR', '等待恢复', '3', '3', '99', null, null, '等待电路恢复到主用信道', '对业务没有影响', null, '1', '保护工作在备用，且主备用均无告警，在等待恢复时间内', '等待电路恢复到主用信道', null);
INSERT INTO `warninglevel` VALUES ('21', 'ETH_MMG', '以太网不期望的维护实体组', '3', '3', '100', null, '1', '以太网不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查以太网两端MEG信息是否匹配', null);
INSERT INTO `warninglevel` VALUES ('22', 'ETH_UNM', '以太网不期望的维护实体组端点', '3', '3', '101', null, '1', '以太网不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查以太网两端MEP是否匹配', null);
INSERT INTO `warninglevel` VALUES ('23', 'ETH_UNP', '以太网时间间隔失配', '3', '3', '102', null, '1', '以太网时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查以太网两端CCM报文周期是否匹配', null);
INSERT INTO `warninglevel` VALUES ('24', 'ETH_RDI', '以太网远端故障指示', '3', '3', '103', null, '1', '以太网远端故障指示', '业务可能中断', '', '1', 'RDI', '检查对端是否存在以太网LOC/MMG/UNM等告警，先消除对端告警', null);
INSERT INTO `warninglevel` VALUES ('25', 'TMP_UNP', '通道时间间隔失配', '3', '3', '104', null, '1', '通道时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查LSP两端CV帧周期是否匹配', null);
INSERT INTO `warninglevel` VALUES ('26', 'TMC_UNP', '通路时间间隔失配', '3', '3', '105', null, '1', '通路时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查PW两端CV帧周期是否匹配', null);
INSERT INTO `warninglevel` VALUES ('27', 'TMP_RDI', '通道远端故障指示', '3', '3', '106', null, '1', '通道远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在LSP层LOC/MMG/UNM等告警，先消除对端告警', null);
INSERT INTO `warninglevel` VALUES ('28', 'TMC_RDI', '通路远端故障指示', '3', '3', '107', null, '1', '通路远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在PW层LOC/MMG/UNM等告警，先消除对端告警', null);
INSERT INTO `warninglevel` VALUES ('29', 'TMP_AIS', '通道告警指示信号', '3', '3', '108', null, '1', '通道告警指示信号', null, null, '1', 'AIS', null, null);
INSERT INTO `warninglevel` VALUES ('30', 'TMC_AIS', '通路告警指示信号', '3', '3', '109', null, '1', '通路告警指示信号', null, null, '1', 'AIS', null, null);
INSERT INTO `warninglevel` VALUES ('31', 'TMP_MMG', '通道不期望的维护实体组', '3', '3', '110', null, '1', '通道不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查LSP两端MEG信息是否匹配', null);
INSERT INTO `warninglevel` VALUES ('32', 'TMC_MMG', '通路不期望的维护实体组', '3', '3', '111', null, '1', '通路不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查PW两端MEG信息是否匹配', null);
INSERT INTO `warninglevel` VALUES ('33', 'TMP_UNM', '通道不期望的维护实体组端点', '3', '3', '112', null, '1', '通道不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查LSP两端MEP是否匹配', null);
INSERT INTO `warninglevel` VALUES ('34', 'TMC_UNM', '通路不期望的维护实体组端点', '3', '3', '113', null, '1', '通路不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查PW两端MEP是否匹配', null);
INSERT INTO `warninglevel` VALUES ('35', 'TMC_CSF', '通路客户信号失效', '3', '3', '114', null, null, '通路客户信号失效', '业务中断', null, '1', '本端客户层信号失效', '检查UNI口光纤是否连接好', null);
INSERT INTO `warninglevel` VALUES ('36', 'CFG_MISMATCH', '配置失配', '3', '3', '115', null, null, '配置失配', '业务中断', null, '1', '网管配置数据不正确', '检查网管配置', null);
INSERT INTO `warninglevel` VALUES ('37', 'TMS_UNP', '段时间间隔失配', '3', '3', '116', null, '1', '段时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查段层两端CV帧周期是否匹配', null);
INSERT INTO `warninglevel` VALUES ('38', 'TMS_RDI', '段远端故障指示', '3', '3', '117', null, '1', '段远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在段层连通性检测相关告警，先解决对端告警', null);
INSERT INTO `warninglevel` VALUES ('39', 'TMS_AIS', '段告警指示信号', '3', '3', '118', null, null, '段告警指示信号', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('40', 'TMS_MMG', '段不期望的维护实体组', '3', '3', '119', null, '1', '段不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查段两端MEG信息是否匹配', null);
INSERT INTO `warninglevel` VALUES ('41', 'TMS_UNM', '段不期望的维护实体组端点', '3', '3', '120', null, '1', '段不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查段两端MEP是否匹配', null);
INSERT INTO `warninglevel` VALUES ('42', 'CRC_ERR', 'CRC校验错', '3', '3', '121', '端口', '2', 'CRC校验错', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', null);
INSERT INTO `warninglevel` VALUES ('43', 'RX_ERR', '收坏包过限', '3', '3', '122', null, '2', '收坏包过限', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', null);
INSERT INTO `warninglevel` VALUES ('44', 'ALN_ERR', '对齐错误过限', '3', '3', '123', null, '2', '对齐错误过限', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', null);
INSERT INTO `warninglevel` VALUES ('45', 'CLKI_AIS', '外时钟输入源AIS', '3', '3', '124', null, null, '外时钟输入源AIS', '对业务没有影响', null, '1', '远端信号丢失', '检查光纤光模块及该端口是否异常', null);
INSERT INTO `warninglevel` VALUES ('46', 'E1_AIS', '2M告警指示信号', '3', '3', '125', null, '1', '2M告警指示信号', '远端2M业务丢失', null, '1', 'AIS', '检测上游设备2M业务是否正常，是否E1_LOS', null);
INSERT INTO `warninglevel` VALUES ('47', 'ETHLB_LOS', '以太网环回信号超时', '2', '2', '197', null, null, '以太网环回信号超时', '业务中断', null, '1', '以太网OAM收环回帧超时', '链路异常，检查链路报文收发情况', null);
INSERT INTO `warninglevel` VALUES ('48', 'CUR_LOCK', '当前状态锁定', '2', '2', '177', null, null, '当前状态锁定', '对业务没有影响影响', null, '1', '设备处于时钟锁定状态', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('49', 'FORCE_SWITCH', '强制倒换', '2', '2', '178', null, null, '强制倒换', '对业务没有影响', null, '1', '下强制倒换控制命令', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('50', 'MANUAL_SWITCH', '人工倒换', '2', '2', '179', null, null, '人工倒换', '对业务没有影响', null, '1', '下人工倒换控制命令', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('51', 'REF_SWITCH', '时钟参考源切换', '2', '2', '181', null, null, '时钟参考源切换', '对业务没有影响', null, '1', '时钟参考源人工或者链路问题致切换', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('52', 'LOCK_MAIN', '锁定到主用', '2', '2', '182', null, null, '锁定到主用', '对业务没有影响', null, '1', '下锁定到主用控制命令', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('53', 'TMP_LCK', '通道锁定', '2', '2', '183', null, '1', '通道锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', null);
INSERT INTO `warninglevel` VALUES ('54', 'TMC_LCK', '通路锁定', '2', '2', '184', null, '1', '通路锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', null);
INSERT INTO `warninglevel` VALUES ('55', 'TMS_LCK', '段锁定', '2', '2', '185', null, '1', '段锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', null);
INSERT INTO `warninglevel` VALUES ('56', 'ETH_LCK', '以太网锁定', '2', '2', '186', null, '1', '以太网锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', null);
INSERT INTO `warninglevel` VALUES ('57', 'TMPLB_LOS', '通道环回信号超时', '2', '2', '187', null, '1', '通道环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', null);
INSERT INTO `warninglevel` VALUES ('58', 'TMCLB_LOS', '通路环回信号超时', '2', '2', '188', null, '1', '通路环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', null);
INSERT INTO `warninglevel` VALUES ('59', 'TMSLB_LOS', '段环回信号超时', '2', '2', '189', null, '1', '段环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', null);
INSERT INTO `warninglevel` VALUES ('60', 'LOOP', '设备环回', '2', '2', '190', null, '4', '设备环回', '对非相关端口的业务无影响', null, '1', 'configurationorCustomizingError ', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('61', 'LOOPL', '线路环回', '2', '2', '191', null, '4', '线路环回', '对非相关端口的业务无影响', null, '1', 'configurationorCustomizingError', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('62', 'PORT_MIRROR', '端口镜像', '2', '2', '192', null, '4', '端口镜像', '对非相关端口的业务无影响', null, '1', 'configurationorCustomizingError', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('63', 'PORT_OFF', '端口关断', '2', '2', '193', null, '1', '端口关断', '对非相关端口的业务无影响', null, '1', 'dCCFailure', '提示告警，无需检查', null);
INSERT INTO `warninglevel` VALUES ('64', 'ES_LIMIT  ', '误码秒超限', '2', '2', '194', null, '1', '误码秒超限', null, null, '1', 'ES_LIMIT  ', null, null);
...
INSERT INTO `warninglevel` VALUES ('79', 'PKG_TYPE', '物理板和逻辑板不一致;或物理板刚刚插上,未启动好', '5', '5', '28', null, '3', '物理板和逻辑板不一致;或物理板刚刚插上,未启动好', null, null, '2', null, null, null);
...
INSERT INTO `warninglevel` VALUES ('139', 'LRSOFFLINE', '光模块不在位', '5', '5', '16', null, '1', '光模块不在位', '端口没有插入光模块', null, '1', 'dCCFailure', '检测该端口是否插入光模块', null);
INSERT INTO `warninglevel` VALUES ('140', 'SFP_NOLIGH', '光模块无光', '5', '5', '17', null, '1', '光模块无光', '端口没有插入光模块', null, '1', 'dCCFailure', '检测该端口的光纤是否正常', null);
INSERT INTO `warninglevel` VALUES ('141', 'SFP_FAULT', '光模块故障', '5', '5', '18', null, '1', '光模块故障', '光模块发生故障，业务断', null, '1', 'dCCFailure', '更换光模块', null);
INSERT INTO `warninglevel` VALUES ('142', 'E1_LOOPL', 'E1线路环回', '2', '2', '195', null, '4', 'E1线路环回', '本地E1业务环回', null, '1', 'configurationorCustomizingError', '下发控制命令的关E1线路环回', null);
INSERT INTO `warninglevel` VALUES ('143', 'E1_LOOPD', 'E1设备环回', '2', '2', '196', null, '4', 'E1设备环回', '远端进来的E1业务环回回去', null, '1', 'configurationorCustomizingError', '下发控制命令的关E1设备环回', null);
INSERT INTO `warninglevel` VALUES ('144', 'E1_LOF ', '2M帧失步告警', '5', '5', '19', null, '1', '2M帧失步告警', null, null, '1', 'LOF', null, null);
INSERT INTO `warninglevel` VALUES ('145', 'E1_LOM', '2M复帧失步告警', '5', '5', '20', null, '1', '2M复帧失步告警', null, null, '1', 'LOM', null, null);
INSERT INTO `warninglevel` VALUES ('146', 'BACKUP_FAULT', '备用故障', '2', '2', '180', null, '1', '备用故障', '主用链路正常工作的情况下，对业务没有影响；主用链路异常则业务中断', null, '1', 'BACKUP_FAULT', '根据备用链路告警信息处理备用链路故障', null);
INSERT INTO `warninglevel` VALUES ('147', 'E1_CRC', '2M CRC校验错', '3', '3', '126', null, '1', '2M CRC校验错', null, null, '1', 'CRC', null, null);
INSERT INTO `warninglevel` VALUES ('148', 'E1_RDI', '2M远端缺陷指示', '3', '3', '127', null, '1', '2M远端缺陷指示', null, null, '1', 'RDI', null, null);
INSERT INTO `warninglevel` VALUES ('149', 'E1_MRDI', 'E1 MRDI', '3', '3', '128', null, '1', 'E1 MRDI', null, null, '1', 'MRDI', null, null);
INSERT INTO `warninglevel` VALUES ('150', 'SFP_TempHigh', '光模块温度过高', '5', '5', '22', null, '5', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '对业务无影响', null, '1', 'highTemperature', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', null);
INSERT INTO `warninglevel` VALUES ('151', 'SFP_TempLow', '光模块温度过低', '5', '5', '23', null, '5', '光模块温度过低', '对业务无影响', null, '1', 'lowTemperature', '检测设备的温度，查看模块的温度数值', null);
INSERT INTO `warninglevel` VALUES ('152', 'SFP_VccHigh', '光模块工作电压过高', '5', '5', '24', null, '1', '光模块工作电压过高', null, null, '1', 'VccHigh', null, null);
INSERT INTO `warninglevel` VALUES ('153', 'SFP_VccLow', '光模块工作电压过低', '5', '5', '25', null, '1', '光模块工作电压过低', null, null, '1', 'VccLow', null, null);
INSERT INTO `warninglevel` VALUES ('154', 'SFP_TxBiasHigh', '光模块发射偏流过高', '5', '5', '26', null, '1', '光模块发射偏流过高', null, null, '1', 'TxBiasHigh', null, null);
INSERT INTO `warninglevel` VALUES ('155', 'SFP_TxBiasLow', '光模块发射偏流过低', '5', '5', '27', null, '1', '光模块发射偏流过低', null, null, '1', 'TxBiasLow', null, null);
INSERT INTO `warninglevel` VALUES ('156', 'SFP_TxPowHigh', '光模块发射光功率过高', '5', '5', '28', null, '1', '光模块发射光功率过高', null, null, '1', 'Excessive transmitter output power', null, null);
INSERT INTO `warninglevel` VALUES ('157', 'SFP_TxPowLow', '光模块发射光功率过低', '5', '5', '29', null, '3', '光模块发射光功率过低', null, null, '1', 'Reduced transmitter output power', null, null);
INSERT INTO `warninglevel` VALUES ('158', 'SFP_RxPowHigh', '光模块接收光功率过高', '5', '5', '30', null, '3', '光模块接收光功率过高', null, null, '1', 'Excessive transmitter input power', null, null);
INSERT INTO `warninglevel` VALUES ('159', 'SFP_RxPowLow', '光模块接收光功率过低', '5', '5', '32', null, '3', '光模块接收光功率过低', null, null, '1', 'Reduced transmitter input power', null, null);
INSERT INTO `warninglevel` VALUES ('160', 'Ci_TempHigh', '设备温度过高告警', '5', '5', '33', null, '2', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '可能导致业务误码', null, '1', 'Threshold Crossed ', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', null);
INSERT INTO `warninglevel` VALUES ('161', 'Ci_TempLow', '设备温度过低告警', '5', '5', '34', null, '2', '外界温度低于设备正常工作的最低温度', '可能导致业务误码', null, '1', 'Threshold Crossed', '关闭风扇；调节机房温度到设备正常工作温度范围内', null);
INSERT INTO `warninglevel` VALUES ('162', 'OAM_PEER_DYING_GASP', '对端dying gasp事件', '5', '5', '35', null, '3', '对端dying gasp事件', '业务中断', null, '1', 'Dying Gasp', '对端设备上电', null);
INSERT INTO `warninglevel` VALUES ('163', 'OAM_PEER_LINK_FAULT', '对端link fault', '5', '5', '36', null, '1', '对端link fault', '业务中断', null, '1', 'Link Fault', '检查光纤连接是否正常', null);
INSERT INTO `warninglevel` VALUES ('164', 'OAM_PEER_CRITICAL', '对端critical事件', '5', '5', '37', null, '1', '对端critical事件', null, null, '1', 'PEER_CRITICAL', null, null);
INSERT INTO `warninglevel` VALUES ('165', 'OAM_PEER_ERR_SYMBOL', '对端错误符号门限事件', '4', '4', '68', null, '1', '对端错误符号门限事件', '对业务没有影响', null, '1', 'PEER_ERR_SYMBOL', '检查链路是否异常', null);
INSERT INTO `warninglevel` VALUES ('166', 'OAM_PEER_ERR_FRAME', '对端错误帧门限事件', '4', '4', '69', null, '1', '对端错误帧门限事件', '对业务没有影响', null, '1', 'PEER_ERR_FRAME', '检查链路是否异常', null);
INSERT INTO `warninglevel` VALUES ('167', 'OAM_PEER_ERR_FRAME_PERIOD', '对端错误帧周期门限事件', '4', '4', '70', null, '1', '对端错误帧周期门限事件', '对业务没有影响', null, '1', 'PEER_ERR_FRAME_PERIOD', '检查链路是否异常', null);
INSERT INTO `warninglevel` VALUES ('168', 'OAM_PEER_ERR_FRAME_SECOND', '对端错误帧秒门限事件', '4', '4', '71', null, '1', '对端错误帧秒门限事件', '对业务没有影响', null, '1', 'PEER_ERR_FRAME_SECOND', '检查链路是否异常', null);
INSERT INTO `warninglevel` VALUES ('169', 'ETH_UNL', '以太网不期望的维护域级别', '3', '3', '132', null, '1', '以太网不期望的维护域级别', '对业务没有影响', null, '1', 'UNL', '检查以太网两端维护域级别是否匹配', null);
INSERT INTO `warninglevel` VALUES ('170', 'ETH_AIS', '以太网告警指示信号', '3', '3', '131', null, '1', '以太网告警指示信号', '对业务没有影响', null, '1', 'AIS', '检查其服务层告警', null);
INSERT INTO `warninglevel` VALUES ('171', 'ETH_XCON_CCM', '以太网维护域交叉连接错误', '3', '3', '130', null, '1', '以太网维护域交叉连接错误', '对业务没有影响', null, '1', 'XCON_CCM', '检查两端配置mep级别或者ma名字是否匹配', null);
INSERT INTO `warninglevel` VALUES ('172', 'ETH_ERROR_CCM', '以太网维护域时间间隔错误', '3', '3', '129', null, '1', '以太网维护域时间间隔错误', '对业务没有影响', null, '1', 'ERROR_CCM', '检查两端周期是否一致、mep是否匹配', null);
INSERT INTO `warninglevel` VALUES ('173', 'ETH_REMOTE_CCM', '以太网远端信号丢失', '5', '5', '21', null, '1', '以太网远端信号丢失', '对业务没有影响', null, '1', 'remoteCCMDefect', '检查链路或者对端配置', null);
INSERT INTO `warninglevel` VALUES ('174', 'ETH_MAC_STATUS', '以太网维护端点端口错误', '2', '2', '198', null, '1', '以太网维护端点端口错误', '', null, '1', 'MAC_STATUS', '', null);
INSERT INTO `warninglevel` VALUES ('175', 'ETH_RDI_CCM ', '以太网远端错误指示', '2', '2', '199', '', '1', '以太网远端错误指示', '对业务没有影响', '', '1', 'RDI', '检查链路或者对端配置', null);
INSERT INTO `warninglevel` VALUES ('176', 'Ci_TempThreshHigh', '设备温度过高门限越限', '5', '5', '38', null, '2', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '对业务没有影响', null, '1', 'Threshold Crossed', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', null);
INSERT INTO `warninglevel` VALUES ('177', 'Ci_TempThreshLow', '设备温度过低门限越限', '5', '5', '39', null, '2', '外界温度低于设备正常工作的最低温度', '对业务没有影响', null, '1', 'Threshold Crossed', '关闭风扇；调节机房温度到设备正常工作温度范围内', null);
INSERT INTO `warninglevel` VALUES ('178', 'OAM_PEER_DISCOVERY', 'OAM 发现对端', '2', '2', '211', null, '1', 'OAM_PEER_DISCOVERY', '对业务没有影响', null, '1', 'PEER_DISCOVERY', '无需处理', null);
INSERT INTO `warninglevel` VALUES ('179', 'OAM_LOOPBACK_TIMEOUT', 'OAM环回超时', '2', '2', '212', null, '1', 'OAM_LOOPBACK_TIMEOUT', '业务可能中断', null, '1', 'LOOPBACK_TIMEOUT', '检查链路或者对端配置', null);
INSERT INTO `warninglevel` VALUES ('180', 'LBD_DISCOVERY', '以太网发现环路', '4', '4', '72', null, '1', 'LBD_DISCOVERY', '业务可能中断', null, '1', 'LBD_DISCOVERY', '检查设备连接拓扑', null);
INSERT INTO `warninglevel` VALUES ('181', 'VoltageHign', '设备电压过高(>14V)', '5', '5', '40', null, '6', 'VoltageHign', '机房电源供电系统异常；机房停电，电池供电时间过长', null, '1', 'powerProblem', '检查机房电源供电系统；检查机房是否停电，在电池供电电压下降时及时进行发电，避免设备停电', null);
INSERT INTO `warninglevel` VALUES ('182', 'VoltageLow', '设备电压过低(<9V)', '5', '5', '41', null, '6', 'VoltageLow', '机房电源供电系统异常；机房停电，电池供电时间过长', null, '1', 'powerProblem', '检查机房电源供电系统；检查机房是否停电，在电池供电电压下降时及时进行发电，避免设备停电', null);
INSERT INTO `warninglevel` VALUES ('183', 'FAN_FAULT', '风扇故障或不在位', '5', '5', '48', null, '1', '风扇故障或不在位', '业务可能因温度过高而误码', null, '1', 'FAN_FAULT', '检查风扇', null);
INSERT INTO `warninglevel` VALUES ('184', 'FAN_ERROR_SPEED', '风扇转速过缓', '5', '5', '49', null, '1', '风扇转速过缓', '业务可能因温度过高而误码', null, '1', 'ERROR_SPEED', '检查风扇和网管配置', null);
INSERT INTO `warninglevel` VALUES ('185', 'REMOTE_DEVICE_POWER_ON', '远端设备上电', '2', '2', '213', null, '1', '远端设备上电', '业务恢复', null, '1', 'REMOTE_DEVICE_POWER_ON', '无需处理', null);
INSERT INTO `warninglevel` VALUES ('186', 'REMOTE_DEVICE_POWER_DOWN', '远端设备掉电', '2', '2', '214', null, '1', '远端设备掉电', '业务中断', null, '1', 'REMOTE_DEVICE_POWER_DOWN', '设备加电', null);
INSERT INTO `warninglevel` VALUES ('187', 'CONTEXT_PACKET_LOS', '本端链路包丢失', '5', '5', '15', '', '1', '本端链路包丢失', '', '', '1', 'CONTEXT_PACKET_LOS', null, null);
INSERT INTO `warninglevel` VALUES ('188', 'RCONTEXT_PACKET_LOS', '远端链路包丢失', '3', '3', '133', '', '1', '远端链路包丢失', '', '', '1', 'RCONTEXT_PACKET_LOS', null, null);
INSERT INTO `warninglevel` VALUES ('189', 'USER_LOCK', '用户被锁定', '2', '2', '1000', null, '1', '用户被锁定', '对业务没有影响', null, '1', 'LOCK', '输入正确密码', null);
INSERT INTO `warninglevel` VALUES ('190', 'USERPASSWORERROR', '用户登录密码输入错误', '2', '2', '1050', null, '1', '用户登录密码输入错误', '对业务没有影响', null, '1', 'PASSWORERROR', '输入正确密码', null);
INSERT INTO `warninglevel` VALUES ('191', 'PERFORMANCETIME', '性能文件超存储时间', '2', '2', '1002', null, '1', '性能文件超存储时间', '对业务没有影响', null, '1', 'PERFORMANCETIME', '设置性能文件的存储时间', null);
INSERT INTO `warninglevel` VALUES ('192', 'PERFORMANCERAMERROR', '性能文件存储内存溢出错误', '2', '2', '1001', null, '1', '性能文件存储内存溢出错误', '对业务没有影响', null, '1', 'PERFORMANCERAMERROR', '重新设置性能文件的存储内存', null);
INSERT INTO `warninglevel` VALUES ('193', 'USERNAMEERROR', '用户登录名输入错误', '2', '2', '1051', null, '1', '用户登录名输入错误', '对业务没有影响', null, '1', 'userNameERROR', '输入正确用户名', null);
