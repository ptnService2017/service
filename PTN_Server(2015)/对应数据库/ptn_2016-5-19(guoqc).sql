...
CREATE TABLE `all_config` (
  ...
  `alarmModel` int(11) DEFAULT NULL,
  `alarmPort` int(11) DEFAULT NULL,
  `loopAvoid` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `arpinfo`
-- ----------------------------
DROP TABLE IF EXISTS `arpinfo`;
CREATE TABLE `arpinfo` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pwProtectId` int(11) DEFAULT NULL,
  `name` varchar(200) DEFAULT NULL,
  `sourceMac` varchar(200) DEFAULT NULL,
  `vlanEnabled` int(4) DEFAULT NULL,
  `vlanId` int(11) DEFAULT NULL,
  `vlanPri` int(4) DEFAULT NULL,
  `sourceIp` varchar(200) DEFAULT NULL,
  `targetIp` varchar(200) DEFAULT NULL,
...
-- ----------------------------
-- Table structure for `bfd_ipv4`
-- ----------------------------
DROP TABLE IF EXISTS `bfd_ipv4`;
CREATE TABLE `bfd_ipv4` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `siteId` int(11) DEFAULT NULL,
  `bfdId` int(11) DEFAULT NULL,
  `bfdEnabel` int(11) DEFAULT NULL,
  `testMode` int(11) DEFAULT NULL,
  `bfdMessageSendType` int(11) DEFAULT NULL,
  `vlanPriority` int(11) DEFAULT NULL,
  `vlanId` int(11) DEFAULT NULL,
  `serviceType` int(11) DEFAULT NULL,
  `localIp` varchar(200) DEFAULT NULL,
  `peerIp` varchar(200) DEFAULT NULL,
  `udpPort` int(11) DEFAULT NULL,
  `mySid` int(11) DEFAULT NULL,
  `peerStudyEnabel` int(11) DEFAULT NULL,
  `peerSid` int(11) DEFAULT NULL,
  `dmti` int(11) DEFAULT NULL,
  `rmri` int(11) DEFAULT NULL,
  `dectMul` int(11) DEFAULT NULL,
  `pwBfdStyle` int(11) DEFAULT NULL,
  `pwTtl` int(11) DEFAULT NULL,
  `tLayelPortMark` int(11) DEFAULT NULL,
...
INSERT INTO `capability` VALUES ('242', '1731', 'Eth_PackDelay_ms', 'ETH OAM delay', '', null, '144', null, '1', 'ms', 'ETH OAM delay');
INSERT INTO `capability` VALUES ('243', '1731', 'EthPackDelay_Shake_ms', 'ETH OAM jitter', '', null, '145', null, '1', 'ms', 'ETH OAM jitter');
...
INSERT INTO `code` VALUES ('793', '201', '1', 'E2E', null, null);
INSERT INTO `code` VALUES ('794', '201', '2', 'P2P', null, null);
...
INSERT INTO `code` VALUES ('836', '208', '1', 'NNI侧模式', null, null);
INSERT INTO `code` VALUES ('837', '208', '2', 'UNI侧模式', null, null);
INSERT INTO `code` VALUES ('838', '208', '3', '802.3ah模式', null, null);
INSERT INTO `code` VALUES ('839', '209', '0', '关', null, null);
INSERT INTO `code` VALUES ('840', '209', '1', '开', null, null);
INSERT INTO `code` VALUES ('841', '210', '0', '单跳检测', null, null);
INSERT INTO `code` VALUES ('842', '210', '1', '多跳检测', null, null);
INSERT INTO `code` VALUES ('843', '211', '0', 'IP', null, null);
INSERT INTO `code` VALUES ('844', '211', '1', 'LSP', null, null);
INSERT INTO `code` VALUES ('845', '211', '2', 'PW+LSP', null, null);
INSERT INTO `code` VALUES ('846', '212', '1', '1', null, null);
INSERT INTO `code` VALUES ('847', '212', '2', '2', null, null);
INSERT INTO `code` VALUES ('848', '212', '3', '3', null, null);
INSERT INTO `code` VALUES ('849', '212', '4', '4', null, null);
INSERT INTO `code` VALUES ('850', '212', '5', '5', null, null);
INSERT INTO `code` VALUES ('851', '212', '6', '6', null, null);
INSERT INTO `code` VALUES ('852', '212', '7', '7', null, null);
INSERT INTO `code` VALUES ('853', '213', '0', '一般服务', null, null);
INSERT INTO `code` VALUES ('854', '213', '2', '最小费用', null, null);
INSERT INTO `code` VALUES ('855', '213', '4', '最高可靠性', null, null);
INSERT INTO `code` VALUES ('856', '213', '8', '最大吞吐量', null, null);
INSERT INTO `code` VALUES ('857', '213', '16', '最小时延', null, null);
INSERT INTO `code` VALUES ('858', '215', '1', '3.3ms', null, null);
INSERT INTO `code` VALUES ('859', '215', '2', '10ms', null, null);
INSERT INTO `code` VALUES ('860', '215', '3', '20ms', null, null);
INSERT INTO `code` VALUES ('861', '215', '4', '30ms', null, null);
INSERT INTO `code` VALUES ('862', '215', '5', '40ms', null, null);
INSERT INTO `code` VALUES ('863', '215', '6', '50ms', null, null);
INSERT INTO `code` VALUES ('864', '215', '7', '60ms', null, null);
INSERT INTO `code` VALUES ('865', '215', '8', '70ms', null, null);
INSERT INTO `code` VALUES ('866', '215', '9', '80ms', null, null);
INSERT INTO `code` VALUES ('867', '215', '10', '90ms', null, null);
INSERT INTO `code` VALUES ('868', '215', '11', '100ms', null, null);
INSERT INTO `code` VALUES ('869', '215', '12', '200ms', null, null);
INSERT INTO `code` VALUES ('870', '215', '13', '300ms', null, null);
INSERT INTO `code` VALUES ('871', '215', '14', '400ms', null, null);
INSERT INTO `code` VALUES ('872', '215', '15', '500ms', null, null);
INSERT INTO `code` VALUES ('873', '215', '16', '150ms', null, null);
INSERT INTO `code` VALUES ('874', '215', '17', '250ms', null, null);
INSERT INTO `code` VALUES ('875', '215', '18', '350ms', null, null);
INSERT INTO `code` VALUES ('876', '215', '19', '450ms', null, null);
INSERT INTO `code` VALUES ('877', '215', '20', '1000ms', null, null);
INSERT INTO `code` VALUES ('878', '214', '0', '不使能', null, null);
INSERT INTO `code` VALUES ('879', '214', '1', '使能', null, null);
INSERT INTO `code` VALUES ('880', '216', '1', '3.3ms', null, null);
INSERT INTO `code` VALUES ('881', '216', '2', '10ms', null, null);
INSERT INTO `code` VALUES ('882', '216', '3', '20ms', null, null);
INSERT INTO `code` VALUES ('883', '216', '4', '30ms', null, null);
INSERT INTO `code` VALUES ('884', '216', '5', '40ms', null, null);
INSERT INTO `code` VALUES ('885', '216', '6', '50ms', null, null);
INSERT INTO `code` VALUES ('886', '216', '7', '60ms', null, null);
INSERT INTO `code` VALUES ('887', '216', '8', '70ms', null, null);
INSERT INTO `code` VALUES ('888', '216', '9', '80ms', null, null);
INSERT INTO `code` VALUES ('889', '216', '10', '90ms', null, null);
INSERT INTO `code` VALUES ('890', '216', '11', '100ms', null, null);
INSERT INTO `code` VALUES ('891', '216', '12', '200ms', null, null);
INSERT INTO `code` VALUES ('892', '216', '13', '300ms', null, null);
INSERT INTO `code` VALUES ('893', '216', '14', '400ms', null, null);
INSERT INTO `code` VALUES ('894', '216', '15', '500ms', null, null);
INSERT INTO `code` VALUES ('895', '216', '16', '150ms', null, null);
INSERT INTO `code` VALUES ('896', '216', '17', '250ms', null, null);
INSERT INTO `code` VALUES ('897', '216', '18', '350ms', null, null);
INSERT INTO `code` VALUES ('898', '216', '19', '450ms', null, null);
INSERT INTO `code` VALUES ('899', '216', '20', '1000ms', null, null);
INSERT INTO `code` VALUES ('900', '217', '0', 'PW-ACH封装', null, null);
INSERT INTO `code` VALUES ('901', '217', '1', 'IPv4-UDP封装', null, null);
INSERT INTO `code` VALUES ('902', '217', '2', 'IPv6-UDP封装', null, null);
INSERT INTO `code` VALUES ('903', '217', '3', 'CCTYPE2封装', null, null);
INSERT INTO `code` VALUES ('904', '218', '0', '不是', null, null);
INSERT INTO `code` VALUES ('905', '218', '1', '是', null, null);
INSERT INTO `code` VALUES ('906', '219', '1', 'LOOPback0', null, null);
INSERT INTO `code` VALUES ('907', '219', '2', 'NMS', null, null);
INSERT INTO `code` VALUES ('908', '219', '3', 'PCIE2', null, null);
INSERT INTO `code` VALUES ('909', '219', '4', 'PCIE3', null, null);
INSERT INTO `code` VALUES ('910', '220', '4', 'POINTOMULTIPOINT', null, null);
INSERT INTO `code` VALUES ('911', '220', '0', 'OTHER', null, null);
INSERT INTO `code` VALUES ('912', '188', '6', '下话节点不可达', '0', 'The_Node_Inaccessible');
INSERT INTO `code` VALUES ('913', '188', '7', '锁定主用', '0', 'Lock_The_Main_Use');
INSERT INTO `code` VALUES ('914', '188', '8', '强制备用', '0', 'Mandatory_Spare');
INSERT INTO `code` VALUES ('915', '188', '9', '人工倒换', '0', 'Manual_Switch');
...
INSERT INTO `codegroup` VALUES ('208', '掉电告警上联模式', 'ALARMMODEL', null);
INSERT INTO `codegroup` VALUES ('209', 'BFD会话使能', 'bfdEnabel', null);
INSERT INTO `codegroup` VALUES ('210', '检测方式', 'testMode', null);
INSERT INTO `codegroup` VALUES ('211', 'BFD报文发帧类型', 'bfdMessageSendType', null);
INSERT INTO `codegroup` VALUES ('212', 'VLAN优先级', 'vlanPriority', null);
INSERT INTO `codegroup` VALUES ('213', '服务类型', 'serviceType', null);
INSERT INTO `codegroup` VALUES ('214', '对端会话标识符自学习使能', 'peerStudyEnabel', null);
INSERT INTO `codegroup` VALUES ('215', '发送最小周期DMTI', 'DMTI', null);
INSERT INTO `codegroup` VALUES ('216', '接收最小周期RMRI', 'RMRI', null);
INSERT INTO `codegroup` VALUES ('217', 'PW时BFD封装方式', 'pwBfdStyle', null);
INSERT INTO `codegroup` VALUES ('218', '二层端口BFD标识', 'tLayelPortMark', null);
INSERT INTO `codegroup` VALUES ('219', 'OSPF名称', 'OSPFNAME', null);
INSERT INTO `codegroup` VALUES ('220', 'OSPF接口模式', 'OSPFMODEL', null);

-- ----------------------------
-- Table structure for `consistence_info`
-- ----------------------------
DROP TABLE IF EXISTS `consistence_info`;
CREATE TABLE `consistence_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `siteIds` varchar(200) DEFAULT NULL,
  `serviceTypes` varchar(200) NOT NULL,
  `data` int(11) DEFAULT NULL,
  `timeCycle` int(11) DEFAULT NULL,
  `activeState` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of consistence_info
-- ----------------------------
...
CREATE TABLE `l2cp_inst` (
  ...
  `macAddress` varchar(200) DEFAULT NULL,
  `treatyNumber` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `operationdatalog`
-- ----------------------------
DROP TABLE IF EXISTS `operationdatalog`;
CREATE TABLE `operationdatalog` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `opeLogId` int(200) NOT NULL,
  `value_before` varchar(200) DEFAULT NULL,
  `value_after` varchar(200) DEFAULT NULL,
  `fieldNameId` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Records of operationdatalog
-- ----------------------------
...
CREATE TABLE `operation_log` (
  ...
  `IP` varchar(255) DEFAULT NULL,
  `operationObjName` varchar(255) DEFAULT NULL,
  `siteId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for `ptpport`
-- ----------------------------
DROP TABLE IF EXISTS `ptpport`;
CREATE TABLE `ptpport` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `indexId` int(11) DEFAULT NULL,
  `portNum` int(11) DEFAULT NULL,
  `workModel` int(11) DEFAULT NULL,
  `portId` int(11) DEFAULT NULL,
  `line` int(11) DEFAULT NULL,
  `lineCpn` int(11) DEFAULT NULL,
  `delayMeca` int(11) DEFAULT NULL,
  `MessageMode` int(11) DEFAULT NULL,
  `siteId` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `unload_manager` (
  ...
  `fileWay` varchar(255) DEFAULT '',
  `isAuto` int(11) DEFAULT NULL,
  `autoStartTime` varchar(255) DEFAULT '',
...
-- ----------------------------
INSERT INTO `unload_manager` VALUES ('1', '1', '1', '0', '5000', '1', '0', '', '1', '', '6');
INSERT INTO `unload_manager` VALUES ('2', '2', '1', '0', '5000', '1', '0', '', '1', '', '6');
INSERT INTO `unload_manager` VALUES ('3', '3', '1', '0', '500', '1', '0', '', '1', ' ', '6');
INSERT INTO `unload_manager` VALUES ('4', '4', '1', '0', '5000', '1', '0', '', '0', ' ', '6');
...
INSERT INTO `warninglevel` VALUES ('184', 'FAN_ERROR_SPEED', '风扇转速过缓', '5', '5', '49', null, '1', '风扇转速过缓', '业务可能因温度过高而误码', '', '1', 'ERROR_SPEED', '检查风扇和网管配置', 'Fan Speed Too Slow');
...
INSERT INTO `warninglevel` VALUES ('211', 'DISK_WARNING', '系统盘使用率提示告警', '2', '2', '1068', null, '1', '系统盘使用率提示告警', '对业务没有影响', null, '1', 'Program is too much', '卸载或删除部分程序', '卸载或删除部分程序');
INSERT INTO `warninglevel` VALUES ('212', 'LOCAL_DEVICE_POWER_DOWN', '本端设备掉电', '5', '5', '215', '', '1', '本端设备掉电', '业务中断', '', '1', 'LOCAL_DEVICE_POWER_DOWN', '设备加电', 'LOCAL_DEVICE_POWER_DOWN');
INSERT INTO `warninglevel` VALUES ('213', 'TMC_SW_FAIL', '倒换失败', '4', '4', '144', null, '1', '倒换失败', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('214', 'TMC_SWR', '倒收', '3', '3', '145', null, '1', '倒收', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('215', 'TMC_BRIDGE', '桥接', '3', '3', '146', null, '1', '桥接', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('216', 'TMC_SWTR ', '等待恢复', '3', '3', '147', null, '1', '等待恢复', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('217', 'TMC_FORCE_SWITCH', '强制倒换', '2', '2', '148', null, '1', '强制倒换', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('218', 'TMC_MANUAL_SWITCH', '人工倒换', '2', '2', '149', null, '1', '人工倒换', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('219', 'TMC_LOCK_MAIN', '锁定到主用', '2', '2', '150', null, '1', '锁定到主用', null, null, '1', null, null, null);
INSERT INTO `warninglevel` VALUES ('220', 'TMC_BACKUP_FAULT', '备用故障', '2', '2', '151', null, '1', '备用故障', null, null, '1', null, null, null);

-- ----------------------------
-- Table structure for `wh_ospf`
-- ----------------------------
DROP TABLE IF EXISTS `wh_ospf`;
CREATE TABLE `wh_ospf` (
  ...
  `portType` int(11) DEFAULT NULL,
  `vlanValues` int(11) DEFAULT NULL,
  `folw` int(11) DEFAULT NULL,
  `portModel` int(11) DEFAULT NULL,
  `enable` int(11) DEFAULT NULL,
  `ospfType` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
