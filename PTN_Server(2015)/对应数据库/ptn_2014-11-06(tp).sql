...
INSERT INTO `warninglevel` VALUES ('5', 'PTP_LOS', '精确时间同步丢失', '5', '5', '5', null, null, '精确时间同步丢失', null, null, '1', null, null, 'Precise Time Synchronization Loss');
...
INSERT INTO `warninglevel` VALUES ('9', 'TMP_SSF', '通道服务层信号失效', '5', '5', '9', null, null, '通道服务层信号失效', '业务可能中断', null, '1', '单盘做线路盘时，某条线路link_los或者线路收无光，如果某条入tunnel转发表的入端口是此线路号，那么这条TMP会上报TMP_SSF告警。', '检查链路连接是否正常', 'Channel Service Layer Signal Failure');
INSERT INTO `warninglevel` VALUES ('10', 'TMS_LOC', '段连接确认信号丢失', '5', '5', '10', null, null, '段连接确认信号丢失', '业务可能中断', null, '1', 'LOC', '检查链路连接是否正常，配置是否正确', 'Segment Connection Confirmation Signal Loss');
...
INSERT INTO `warninglevel` VALUES ('12', 'PK_LOS', '丢包率过限', '5', '5', '12', null, '2', '丢包率过限', '业务丢包或误码', null, '1', 'Threshold Crossed', '看是否拥塞或者限速', 'Packet Loss Rate Over The Limit');
INSERT INTO `warninglevel` VALUES ('13', 'CLKI_LOS', '外时钟中断', '5', '5', '13', null, null, '外时钟源坏了；接外时钟的连线断了；时钟盘坏了', '对业务没有影响', null, '1', '外时钟端口down掉', '检查外时钟源工作是否正常；检查外时钟源的连线是否断了或者解除不好；若时钟盘坏了，更换一张时钟盘', 'External Clock Interrupt');
INSERT INTO `warninglevel` VALUES ('14', 'E1_LOS', '2M信号丢失', '5', '5', '14', null, '1', '2M信号丢失', 'E1接口没有信号输入', null, '1', 'LOS', '检测该设备是否连接2M线', '2M Signal Loss');
INSERT INTO `warninglevel` VALUES ('15', 'PTP_PORT_ALM', 'PTP端口异常告警', '4', '4', '65', null, '0', 'PTP端口异常告警', '业务中断', '', '1', 'PTP端口LinkDown', '检查PTP端口状态是否为Down', 'PTP Port Exception Alarm');
INSERT INTO `warninglevel` VALUES ('16', 'TMS_SD', '段信号劣化', '4', '4', '66', null, '0', '可能是接收光功率太小或者太大，在接收机灵敏度附近或者过载；可能是光接头脏了使接收光功率不在正常范围内；光纤转接插头损伤或者解除不良，或者光纤断裂；可能是光路盘有故障', '业务可能中断', '', '1', '复用段信号劣化,暂时没有实现', '用光功率计测量接收光功率；检查接收光功率是否正常；检查光接头断面是否清洁，对端发送光功率是否正常；当接收功率过大时需加衰减器；接收光功率过小时可更换发送光功率大的机盘', 'Segment Signal Degradation');
INSERT INTO `warninglevel` VALUES ('17', 'TMS_SF', '段信号失效', '4', '4', '67', null, null, '当某端设备的群路盘接收侧出线SPI-LOS、RS-LF等故障时，会向下游站传送一个对告信号MS-FERF或MS-RDI；当被测设备出线AU-LOP、TU-LOP…等故障时，会向对端设备发HP-FERF，对端会出现HE-FERF或HP-RDI告警，此告警信号通过发送侧传送到对端设备，对端就检测出了对告指示，产生远端告警，让发送端知道接收端已经收到了发来的高阶通道AIS或者检测到高阶通道失效，并回送一个高阶通道远端接收失效；通道未配置', '业务可能中断', null, '1', null, '由于此告警一般是由对端收不好产生或者本端发不好产生，应处理上游站的故障才能消除失效告警', 'Segment Signal Failure');
...
INSERT INTO `warninglevel` VALUES ('19', 'BRIDGE', '桥接', '5', '5', '98', null, '0', '如果设备采用共享复用段保护环，当环上光纤中断或断裂光路盘出现R-LOS告警或出现R-LOF、MS-AIS、MS-SD(信号劣化)、MS-EXC(复用段误码率突破）。当设备出现上述告警时，设备上相邻两站会发生桥接告警，通过这两个站的电路都会由工作信道桥接到保护信道。', '对业务没有影响', '', '1', '线路自动倒换', '通过网管查找告警类型，根据不同的告警故障采用不同的方法排除故障，当所有群路告警消失后等待几分钟，桥接告警就会消失。电路由保护信道返回到工作信道', 'Bridging');
INSERT INTO `warninglevel` VALUES ('20', 'SWTR', '等待恢复', '3', '3', '99', null, null, '等待电路恢复到主用信道', '对业务没有影响', null, '1', '保护工作在备用，且主备用均无告警，在等待恢复时间内', '等待电路恢复到主用信道', 'Wait For Recovery');
INSERT INTO `warninglevel` VALUES ('21', 'ETH_MMG', '以太网不期望的维护实体组', '3', '3', '100', null, '1', '以太网不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查以太网两端MEG信息是否匹配', 'ETH Undesired Maintenance Entity Group');
INSERT INTO `warninglevel` VALUES ('22', 'ETH_UNM', '以太网不期望的维护实体组端点', '3', '3', '101', null, '1', '以太网不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查以太网两端MEP是否匹配', 'ETH Undesired Maintenance Entity Group Endpoint ');
INSERT INTO `warninglevel` VALUES ('23', 'ETH_UNP', '以太网时间间隔失配', '3', '3', '102', null, '1', '以太网时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查以太网两端CCM报文周期是否匹配', 'ETH Interval Mismatch');
INSERT INTO `warninglevel` VALUES ('24', 'ETH_RDI', '以太网远端故障指示', '3', '3', '103', null, '1', '以太网远端故障指示', '业务可能中断', '', '1', 'RDI', '检查对端是否存在以太网LOC/MMG/UNM等告警，先消除对端告警', 'ETH Remote Fault Indication');
INSERT INTO `warninglevel` VALUES ('25', 'TMP_UNP', '通道时间间隔失配', '3', '3', '104', null, '1', '通道时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查LSP两端CV帧周期是否匹配', 'Channel Interval Mismatch');
INSERT INTO `warninglevel` VALUES ('26', 'TMC_UNP', '通路时间间隔失配', '3', '3', '105', null, '1', '通路时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查PW两端CV帧周期是否匹配', 'Path Interval Mismatch');
INSERT INTO `warninglevel` VALUES ('27', 'TMP_RDI', '通道远端故障指示', '3', '3', '106', null, '1', '通道远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在LSP层LOC/MMG/UNM等告警，先消除对端告警', 'Channel Remote Fault Indication');
INSERT INTO `warninglevel` VALUES ('28', 'TMC_RDI', '通路远端故障指示', '3', '3', '107', null, '1', '通路远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在PW层LOC/MMG/UNM等告警，先消除对端告警', 'Path Remote Fault Indication');
INSERT INTO `warninglevel` VALUES ('29', 'TMP_AIS', '通道告警指示信号', '3', '3', '108', null, '1', '通道告警指示信号', null, null, '1', 'AIS', null, 'Channel Alarm Indication Signal');
INSERT INTO `warninglevel` VALUES ('30', 'TMC_AIS', '通路告警指示信号', '3', '3', '109', null, '1', '通路告警指示信号', null, null, '1', 'AIS', null, 'Path Alarm Indication Signal');
INSERT INTO `warninglevel` VALUES ('31', 'TMP_MMG', '通道不期望的维护实体组', '3', '3', '110', null, '1', '通道不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查LSP两端MEG信息是否匹配', 'Channel Undesired Maintenance Entity Group');
INSERT INTO `warninglevel` VALUES ('32', 'TMC_MMG', '通路不期望的维护实体组', '3', '3', '111', null, '1', '通路不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查PW两端MEG信息是否匹配', 'Path Undesired Maintenance Entity Group');
INSERT INTO `warninglevel` VALUES ('33', 'TMP_UNM', '通道不期望的维护实体组端点', '3', '3', '112', null, '1', '通道不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查LSP两端MEP是否匹配', 'Channel Undesired Maintenance Entity Group Endpoint');
INSERT INTO `warninglevel` VALUES ('34', 'TMC_UNM', '通路不期望的维护实体组端点', '3', '3', '113', null, '1', '通路不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查PW两端MEP是否匹配', 'Path Undesired Maintenance Entity Group Endpoint');
INSERT INTO `warninglevel` VALUES ('35', 'TMC_CSF', '通路客户信号失效', '3', '3', '114', null, null, '通路客户信号失效', '业务中断', null, '1', '本端客户层信号失效', '检查UNI口光纤是否连接好', 'Path client signal failure');
INSERT INTO `warninglevel` VALUES ('36', 'CFG_MISMATCH', '配置失配', '3', '3', '115', null, null, '配置失配', '业务中断', null, '1', '网管配置数据不正确', '检查网管配置', 'Configuration Mismatch');
INSERT INTO `warninglevel` VALUES ('37', 'TMS_UNP', '段时间间隔失配', '3', '3', '116', null, '1', '段时间间隔失配', '对业务没有影响', null, '1', 'UNP', '检查段层两端CV帧周期是否匹配', 'Segment Interval Mismatch');
INSERT INTO `warninglevel` VALUES ('38', 'TMS_RDI', '段远端故障指示', '3', '3', '117', null, '1', '段远端故障指示', '业务可能中断', null, '1', 'RDI', '检查对端是否存在段层连通性检测相关告警，先解决对端告警', 'Segment Remote fault indication');
INSERT INTO `warninglevel` VALUES ('39', 'TMS_AIS', '段告警指示信号', '3', '3', '118', null, null, '段告警指示信号', null, null, '1', null, null, 'Segment Alarm Indication Signal');
INSERT INTO `warninglevel` VALUES ('40', 'TMS_MMG', '段不期望的维护实体组', '3', '3', '119', null, '1', '段不期望的维护实体组', '对业务没有影响', null, '1', 'MMG', '检查段两端MEG信息是否匹配', 'Segment Undesired Maintenance Entity Group');
INSERT INTO `warninglevel` VALUES ('41', 'TMS_UNM', '段不期望的维护实体组端点', '3', '3', '120', null, '1', '段不期望的维护实体组端点', '对业务没有影响', null, '1', 'UNM', '检查段两端MEP是否匹配', 'Segment Undesired Maintenance Entity Group Endpoint');
INSERT INTO `warninglevel` VALUES ('42', 'CRC_ERR', 'CRC校验错', '3', '3', '121', '端口', '2', 'CRC校验错', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', 'CRC Error');
INSERT INTO `warninglevel` VALUES ('43', 'RX_ERR', '收坏包过限', '3', '3', '122', null, '2', '收坏包过限', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', 'Receive Bad Packets Over Limit');
INSERT INTO `warninglevel` VALUES ('44', 'ALN_ERR', '对齐错误过限', '3', '3', '123', null, '2', '对齐错误过限', '业务有误码', null, '1', 'Threshold Crossed ', '检查光纤光模块及该端口是否异常', 'Alignment Error Over Limit');
INSERT INTO `warninglevel` VALUES ('45', 'CLKI_AIS', '外时钟输入源AIS', '3', '3', '124', null, null, '外时钟输入源AIS', '对业务没有影响', null, '1', '远端信号丢失', '检查光纤光模块及该端口是否异常', 'External Clock Input Source AIS');
INSERT INTO `warninglevel` VALUES ('46', 'E1_AIS', '2M告警指示信号', '3', '3', '125', null, '1', '2M告警指示信号', '远端2M业务丢失', null, '1', 'AIS', '检测上游设备2M业务是否正常，是否E1_LOS', '2M Alarm Indication Signal');
INSERT INTO `warninglevel` VALUES ('47', 'ETHLB_LOS', '以太网环回信号超时', '2', '2', '197', null, null, '以太网环回信号超时', '业务中断', null, '1', '以太网OAM收环回帧超时', '链路异常，检查链路报文收发情况', 'ETH Loopback Signal Timeout');
INSERT INTO `warninglevel` VALUES ('48', 'CUR_LOCK', '当前状态锁定', '2', '2', '177', null, null, '当前状态锁定', '对业务没有影响影响', null, '1', '设备处于时钟锁定状态', '提示告警，无需检查', 'Current State Locked');
INSERT INTO `warninglevel` VALUES ('49', 'FORCE_SWITCH', '强制倒换', '2', '2', '178', null, null, '强制倒换', '对业务没有影响', null, '1', '下强制倒换控制命令', '提示告警，无需检查', 'Forced Switching');
INSERT INTO `warninglevel` VALUES ('50', 'MANUAL_SWITCH', '人工倒换', '2', '2', '179', null, null, '人工倒换', '对业务没有影响', null, '1', '下人工倒换控制命令', '提示告警，无需检查', 'Manual Switching');
INSERT INTO `warninglevel` VALUES ('51', 'REF_SWITCH', '时钟参考源切换', '2', '2', '181', null, null, '时钟参考源切换', '对业务没有影响', null, '1', '时钟参考源人工或者链路问题致切换', '提示告警，无需检查', 'Clock Reference Source Switch');
INSERT INTO `warninglevel` VALUES ('52', 'LOCK_MAIN', '锁定到主用', '2', '2', '182', null, null, '锁定到主用', '对业务没有影响', null, '1', '下锁定到主用控制命令', '提示告警，无需检查', 'Locked To The Master');
INSERT INTO `warninglevel` VALUES ('53', 'TMP_LCK', '通道锁定', '2', '2', '183', null, '1', '通道锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', 'Channel Lock');
INSERT INTO `warninglevel` VALUES ('54', 'TMC_LCK', '通路锁定', '2', '2', '184', null, '1', '通路锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', 'Path Lock');
INSERT INTO `warninglevel` VALUES ('55', 'TMS_LCK', '段锁定', '2', '2', '185', null, '1', '段锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', 'Segment Lock');
INSERT INTO `warninglevel` VALUES ('56', 'ETH_LCK', '以太网锁定', '2', '2', '186', null, '1', '以太网锁定', '业务中断', null, '1', 'LCK', '对端设备发送了含有此告警的信号，检查对端设备输入业务是否正常', 'ETH Lock');
INSERT INTO `warninglevel` VALUES ('57', 'TMPLB_LOS', '通道环回信号超时', '2', '2', '187', null, '1', '通道环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', 'Channel Loopback Signal Timeout');
INSERT INTO `warninglevel` VALUES ('58', 'TMCLB_LOS', '通路环回信号超时', '2', '2', '188', null, '1', '通路环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', 'Path Loopback Signal Timeout');
INSERT INTO `warninglevel` VALUES ('59', 'TMSLB_LOS', '段环回信号超时', '2', '2', '189', null, '1', '段环回信号超时', '业务可能中断', null, '1', 'Link Fault', '链路异常，检查链路报文收发情况', 'Segment Loopback Signal Timeout');
...
INSERT INTO `warninglevel` VALUES ('63', 'PORT_OFF', '端口关断', '2', '2', '193', null, '1', '端口关断', '对非相关端口的业务无影响', null, '1', 'dCCFailure', '提示告警，无需检查', 'Port Shutdown');
...
INSERT INTO `warninglevel` VALUES ('139', 'LRSOFFLINE', '光模块不在位', '5', '5', '16', null, '1', '光模块不在位', '端口没有插入光模块', null, '1', 'dCCFailure', '检测该端口是否插入光模块', 'Optical Module Not In Position');
INSERT INTO `warninglevel` VALUES ('140', 'SFP_NOLIGH', '光模块无光', '5', '5', '17', null, '1', '光模块无光', '端口没有插入光模块', null, '1', 'dCCFailure', '检测该端口的光纤是否正常', 'Optical Module Without Light');
INSERT INTO `warninglevel` VALUES ('141', 'SFP_FAULT', '光模块故障', '5', '5', '18', null, '1', '光模块故障', '光模块发生故障，业务断', null, '1', 'dCCFailure', '更换光模块', 'Optical Module Fault');
...
INSERT INTO `warninglevel` VALUES ('150', 'SFP_TempHigh', '光模块温度过高', '5', '5', '22', null, '5', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '对业务无影响', null, '1', 'highTemperature', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', 'Optical Module Temperature Too High');
INSERT INTO `warninglevel` VALUES ('151', 'SFP_TempLow', '光模块温度过低', '5', '5', '23', null, '5', '光模块温度过低', '对业务无影响', null, '1', 'lowTemperature', '检测设备的温度，查看模块的温度数值', 'Optical Module Temperature Too Low');
...
INSERT INTO `warninglevel` VALUES ('156', 'SFP_TxPowHigh', '光模块发射光功率过高', '5', '5', '28', null, '1', '光模块发射光功率过高', null, null, '1', 'Excessive transmitter output power', null, 'Optical Module Transmit Optical Power Too High');
INSERT INTO `warninglevel` VALUES ('157', 'SFP_TxPowLow', '光模块发射光功率过低', '5', '5', '29', null, '3', '光模块发射光功率过低', null, null, '1', 'Reduced transmitter output power', null, 'Optical Module Transmit Optical Power Too Low');
INSERT INTO `warninglevel` VALUES ('158', 'SFP_RxPowHigh', '光模块接收光功率过高', '5', '5', '30', null, '3', '光模块接收光功率过高', null, null, '1', 'Excessive transmitter input power', null, 'Optical Module Receives Optical Power Too High');
INSERT INTO `warninglevel` VALUES ('159', 'SFP_RxPowLow', '光模块接收光功率过低', '5', '5', '32', null, '3', '光模块接收光功率过低', null, null, '1', 'Reduced transmitter input power', null, 'Optical Module Receives Optical Power Too Low');
INSERT INTO `warninglevel` VALUES ('160', 'Ci_TempHigh', '设备温度过高告警', '5', '5', '33', null, '2', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '可能导致业务误码', null, '1', 'Threshold Crossed ', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', 'Device Temperature High  Alarm');
INSERT INTO `warninglevel` VALUES ('161', 'Ci_TempLow', '设备温度过低告警', '5', '5', '34', null, '2', '外界温度低于设备正常工作的最低温度', '可能导致业务误码', null, '1', 'Threshold Crossed', '关闭风扇；调节机房温度到设备正常工作温度范围内', 'Device Temperature Low  Alarm');
...
INSERT INTO `warninglevel` VALUES ('169', 'ETH_UNL', '以太网不期望的维护域级别', '3', '3', '132', null, '1', '以太网不期望的维护域级别', '对业务没有影响', null, '1', 'UNL', '检查以太网两端维护域级别是否匹配', 'ETH Unexpect To Maintain Domain Level');
...
INSERT INTO `warninglevel` VALUES ('173', 'ETH_REMOTE_CCM', '以太网远端信号丢失', '5', '5', '21', null, '1', '以太网远端信号丢失', '对业务没有影响', null, '1', 'remoteCCMDefect', '检查链路或者对端配置', 'ETH Distal Signal Loss');
...
INSERT INTO `warninglevel` VALUES ('175', 'ETH_RDI_CCM ', '以太网远端错误指示', '2', '2', '199', '', '1', '以太网远端错误指示', '对业务没有影响', '', '1', 'RDI', '检查链路或者对端配置', 'ETH Remote Error Indication');
INSERT INTO `warninglevel` VALUES ('176', 'Ci_TempThreshHigh', '设备温度过高门限越限', '5', '5', '38', null, '2', '机房空调工作异常；设备风扇工作异常；设备过滤网被灰尘堵塞；盘纤盒内光线过多或者过长，堵塞了通风；2M线和电源线布线不规范，阻挡了散热通道', '对业务没有影响', null, '1', 'Threshold Crossed', '检修机房空调；更换故障风扇；清洗设备防尘网；整理盘纤盒内光线，在盘纤盒内光线不要预留过长，过长部分尽量在ODF架内进行盘纤；规范布线，布线应当不得影响设备通风散热', 'Equipment Temperature Too High Threshold Limit');
INSERT INTO `warninglevel` VALUES ('177', 'Ci_TempThreshLow', '设备温度过低门限越限', '5', '5', '39', null, '2', '外界温度低于设备正常工作的最低温度', '对业务没有影响', null, '1', 'Threshold Crossed', '关闭风扇；调节机房温度到设备正常工作温度范围内', 'Equipment Temperature Too Low Threshold Limit');
